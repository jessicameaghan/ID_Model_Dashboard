...
renderPlot({
  reactiveData()%>%
    mutate("With vaccination" = pmax(diff(c(0, I)), 0),
            ...
            index = 1:n(),
           "With vaccination" = ifelse(index == 1, NA, `With vaccination`),
           Baseline = ifelse(index == 1, NA, Baseline)) %>%  # make the first value of incidence 0 and not what the prevalence was) 
